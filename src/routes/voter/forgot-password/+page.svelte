...
<div class="px-[55px] py-[32px] xs:px-[40px] xs:py-[88px]">
	...
	>
		...
		<Button class=" bg-red-900 mx-auto w-[210px] rounded-[10px] text-[14px] font-semibold"
			>Send Reset Link</Button
		>

		<a
			href="/voter"
			class="text-mainred mx-auto text-[14px] font-semibold underline transition-all hover:text-[#2d2b29]"
			>Log in here</a
		>
	</div>
</div>
